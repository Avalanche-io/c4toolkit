...
## Suite Version 1.0.16

| Component | Version | Language | Install |
|-----------|---------|----------|---------|
| [c4](https://github.com/Avalanche-io/c4) | 1.0.16 | Go | `brew install mrjoshuak/tap/c4` or binary download |
| [c4sh](https://github.com/Avalanche-io/c4sh) | 1.0.16 | Go | included in Homebrew formula |
| [c4git](https://github.com/Avalanche-io/c4git) | 1.0.16 | Go | included in Homebrew formula |
| [c4py](https://github.com/Avalanche-io/c4py) | 1.0.16 | Python | `pip install c4py` |
| [c4ts](https://github.com/Avalanche-io/c4ts) | 1.0.16 | TypeScript | `npm install @avalanche-io/c4` |
| [c4-swift](https://github.com/Avalanche-io/c4-swift) | 1.0.16 | Swift | SPM: `from: "1.0.16"` |
| [libc4](https://github.com/Avalanche-io/libc4) | 1.0.16 | C | build from source |
| [c4-containers](https://github.com/Avalanche-io/c4-containers) | 1.0.16 | Docker | `ghcr.io/avalanche-io/c4` |
